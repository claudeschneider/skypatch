...
files=[root/f for f in ['README.md','CHANGELOG.md','AGENTS.md','LICENSE','package.json','package-lock.json','index.html','vite.config.js','playwright.config.js','playwright.pwa.config.js','.gitignore']]
